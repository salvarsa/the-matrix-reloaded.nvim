...
function M.setup(config)
  ...
  local colors = require("the_matrix_reloaded.colors")
  ...
  theme.base = {
    ...
    ["@constructor"] = { fg = c.green, style = "nocombine" },
    ...
    GitGutterDelete = { fg = c.error },
    debugBreakpoint = { fg = c.error, style = "reverse" },
    ...
    Underlined = { fg = c.green0, style = "underline" },
    ["@variable.cpp"] = { fg = c.foreground },

    -- Nvim Tree
    NvimTreeNormal = { fg = c.green, bg = c.background_dark },
    NvimTreeNormalNC = { fg = c.green, bg = c.background_dark },
    NvimTreeFolderIcon = { fg = c.green },
    NvimTreeRootFolder = { fg = c.green },
    NvimTreeExecFile = { fg = c.green, style = "NONE" },
    ...
    HopNextKey2 = { fg = c.green05, bg = c.dark },
    ...
    rainbowcol2 = { fg = c.green05 },
    rainbowcol3 = { fg = c.green1 },
    rainbowcol4 = { fg = c.green2 },
    rainbowcol5 = { fg = c.green },
    rainbowcol6 = { fg = c.green0 },
    ...
    DiagnosticWarn = { fg = c.green1 },
    DiagnosticInfo = { fg = c.green05 },
    DiagnosticHint = { fg = c.green0 },
    LspReferenceText = { bg = c.highlight },
    LspReferenceRead = { bg = c.highlight },
    LspReferenceWrite = { bg = c.highlight },

    -- Lsp Saga
    LspSagaHoverBorder = { fg = c.green0 },
    LspSagaCodeActionTitle = { fg = c.green1 },
    LspSagaFinderSelection = { bg = c.dark_green },

    -- Git Signs
    GitSignsAdd = { fg = c.green0 },
    GitSignsChange = { fg = c.green05 },
    GitSignsDelete = { fg = c.error },

    -- Git Messenger
    gitmessengerPopupNormal = { bg = c.background_dark },
    gitmessengerHeader = { fg = c.green1 },

    -- BufferLine
    BufferLineFill = { bg = c.background },
    BufferLineBackground = { fg = c.comment, bg = c.background },
    BufferLineBufferSelected = { fg = c.foreground, bg = c.dark, style = "bold" },
    ...
    -- IndentBlankline
    IndentBlanklineContextChar = { fg = c.green2 },
    IndentBlanklineChar = { fg = c.green2 },

    -- Neogit
    NeogitBranch = { fg = c.green0 },
    NeogitRemote = { fg = c.green1 },
    NeogitHunkHeader = { bg = c.highlight },

    -- Lightspeed.nvim
    LightspeedLabel = { fg = c.green1, style = "bold,underline" },
    LightspeedLabelDistant = { fg = c.green05 },
    LightspeedShortcut = { bg = c.green1, fg = c.dark },
   
    -- vim-sneak
    Sneak = { fg = c.background, bg = c.green0 },
    SneakScope = { bg = c.highlight },

    -- Lualine
    LualineNormal = { fg = c.foreground, bg = c.background },
    LualineInsert = { fg = c.green0, bg = c.background },
  ...
  if config.telescope_theme then
    theme.base = vim.tbl_extend("force", theme.base, {
      ...
      TelescopePromptBorder = { fg = c.dark_green, bg = c.dark_green },
      TelescopePromptNormal = { fg = c.foreground, bg = c.dark_green },
      TelescopePromptPrefix = { fg = c.green0, bg = c.dark_green },

      TelescopeNormal = { bg = c.background_dark },

      TelescopePreviewTitle = { fg = c.dark_green, bg = c.green0 },
      TelescopePromptTitle = { fg = c.dark_green, bg = c.green0 },
      TelescopeResultsTitle = { fg = c.dark_green, bg = c.foreground },
